...
export function makeApp(db: Db): core.Express {
  ...
  app.get("/", (request: Request, response: Response) => {
    const url = `https://localhost:3000/oauth/authorize?client_id=${process.env.CONNECT_CLIENT_ID}&redirect_uri=https://localhost:3000/oauth/callback&response_type=code&scope=email%20openid`;
